...
# (Opcional) Regenerar datos desde los CSVs originales
npm run build-data
...
4. Vercel detecta automáticamente Vite — settings por defecto funcionan
5. Click **Deploy**
...
> El archivo `vercel.json` ya incluye las rewrites para SPA routing y cache headers optimizados para assets estáticos y datos.
